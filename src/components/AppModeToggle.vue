...
<template>
    <label @click.prevent="toggleMode" @keydown.enter="toggleMode" class="switch" tabindex="0">
        ...
        <svg class="slider" :class="{'light-mode': !isDarkMode}" width="64" height="32" viewBox="0 0 64 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect class="outline transition" width="64" height="32" rx="15"/>
            ...
            <g mask="url(#mask0_27_190)">
                <g class="circle transition">
                    <circle class="circle__moon transition" cx="47" cy="16" r="12"/>
                    <path class="circle__overlay-moon transition" d="M44.1654 0.110164L27.798 20.5629C27.798 20.5629 32.9536 24.9198 41.5766 21.124C45.3413 19.347 47.5534 17.2411 48.7341 13.3399C51.5359 4.339 44.1654 0.110164 44.1654 0.110164Z" />
                </g>
                <g class="clouds transition">
